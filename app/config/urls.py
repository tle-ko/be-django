...
urlpatterns = [
    ...
    path("api/v1/", include([
        ...
        path("crews/", crews.views.CrewCreateAPIView.as_view()),
        ...
        path("crews/<int:id>/apply", crews.views.CrewApplicantionCreateAPIView.as_view()),
        path("crews/applications/<int:id>/accept", crews.views.CrewApplicantionAcceptAPIView.as_view()),
        path("crews/applications/<int:id>/reject", crews.views.CrewApplicantionRejectAPIView.as_view()),
