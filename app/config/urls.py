...
urlpatterns = [
    ...
    path("api/v1/", include([
        ...
        path("crew/applications/<int:application_id>/accept", crews.views.CrewApplicantionAcceptAPIView.as_view()),
        path("crew/applications/<int:application_id>/reject", crews.views.CrewApplicantionRejectAPIView.as_view()),
