...
urlpatterns = [
    ...
    path("api/v1/", include([
        ...
        path("crew/applications/<int:applicantion_id>/accept", crews.views.CrewApplicantionAcceptAPIView.as_view()),
        path("crew/applications/<int:applicantion_id>/reject", crews.views.CrewApplicantionRejectAPIView.as_view()),
